...
elseif ("${CMAKE_HOST_SYSTEM_NAME}" STREQUAL "Darwin")
    if (PLATFORM_BOARD STREQUAL "Ubuntu")
        message(WARNING "PLATFORM_BOARD=Ubuntu on macOS uses host-native compilation and produces a macOS binary, not a Linux ELF.")
        set(IS_CROSS_COMPILE FALSE)
    else()
        set(IS_CROSS_COMPILE TRUE)
    endif()
